							...
							<div class="row ">
								...
								<div class="col-lg-6 col-md-12 col-sm-12">
									...
									<div class="form-group row mb-0">
										...
										<div class="col-12">
											<textarea required id="description" class="form-control" maxlength="225" rows="3" name="description" placeholder="This text area has a limit of 225 characters." style="resize: none;"></textarea>
										</div>
									</div>
									...
									<div class="form-group row">
										<label for="public" class="col-lg-2 col-form-label">Public:</label>
										<div class="col-12">
											<input class="form-control" type="checkbox" value="1" id="public" name="public">
										</div>
									</div>
