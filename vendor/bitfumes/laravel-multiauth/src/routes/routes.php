...
Route::GET('/home', 'AdminController@index')->name('admin.home');
    ...
    Route::post('api/{api}',[App\Http\Controllers\ApiController::class, 'update']);

    //frontend
    Route::get('/frontend', [App\Http\Controllers\FrontendController::class, 'create'])->name('frontend');
    Route::post('frontend/{frontend}', [App\Http\Controllers\FrontendController::class, 'update']);
    

    //contact
    Route::get('/contact',[App\Http\Controllers\ContactUsController::class, 'index'])->name('contact.index');
    // Route::post('/contact/{contactUs}',[App\Http\Controllers\ContactUsController::class, 'index'])->name('contact.index');
